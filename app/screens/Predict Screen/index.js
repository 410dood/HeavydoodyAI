...
class PredictScreen extends Component {
    ...
    componentDidMount() {
        ...
        clarifai
            ...
            .catch(e => {
                Alert.alert('Une erreur est survenue', 'Désolé, le quota est peut-être dépassé, réessaye plus tard !', [
                    {
                        text: 'OK',
    ...
    render() {
        ...
        return (
            <BackgroundImage
                ...
                resizeMode='cover'>
                <StatusBar hidden/> {this.state.loading
                    ...
                    : <View style={styles.container}>
                        ...
                        <XPButton title='Non merci' color='black' textOnly onPress={this._cancel}/>
                    </View>
}
            </BackgroundImage>
        )
